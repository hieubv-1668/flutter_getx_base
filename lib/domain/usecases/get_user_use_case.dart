...
class GetUserUseCase
    extends UseCase<Pair<List<UserModel>, int>, GetUserUseCaseInput> {
  GetUserUseCase(this.userRepositoryImpl);

  final UserRepositoryImpl userRepositoryImpl;

  @override
  Future<Pair<List<UserModel>, int>> buildUseCase(GetUserUseCaseInput input) {
    return userRepositoryImpl.getUsers(input.page);
  }
}

class GetUserUseCaseInput {
  GetUserUseCaseInput(this.page);
